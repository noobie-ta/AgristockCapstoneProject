...
class VerificationRejectedActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_verification_rejected)
    ...
    private fun loadRejectionData() {
        ...
        firestore.collection("users").document(currentUser.uid)
            ...
            .addOnSuccessListener { document ->
                if (document.exists()) {
                    val rejectionCount = document.getLong("verificationRejectionCount")?.toInt() ?: 1
    ...
    private fun updateRejectionCount(count: Int) {
        ...
        val infoText = if (count > 1) {
            ...
            "You are temporarily unable to resubmit your verification request."
        }
